...
interface HomePageClientProps {
	...
	lastCompleted: TournamentRecord | null;
	upcoming: TournamentRecord | null;
	standings: Standing[];
...
export default function HomePageClient({ activeTournament, lastCompleted, upcoming, standings, championPlayers }: HomePageClientProps) {
